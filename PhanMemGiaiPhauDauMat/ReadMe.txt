...
4. Sau khi cài đặt Python 3.7.0, các phần mềm và phiên bản tương ứng sau đây phải được cài đặt:
	...
	- trimesh==3.5.15
	- chumpy
5. Cài đặt Qt5.12.0 vào máy tính
6. Cài đặt đường dẫn môi trường của máy tính thêm đường dẫn A/BinStore vào danh sách các đường dẫn. Trong đó,
A là thư mục được định nghĩa ở Bước 2.
6. Sau khi cài đặt các gói như quy định, chỉ cần double click vào file: Head2SkullPredictor.exe là có 
thể chạy được chương trình.